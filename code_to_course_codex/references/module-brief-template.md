...
- **Goal focus:** [architecture / debugging / AI steering / product flow / balanced]
- **Depth:** [Low / Medium / Deep]
- **Questions per module:** [default 5 unless intake said otherwise]
...
- [ ] **Quiz** — [number] questions per level. Define `low`, `medium`, and `deep` tracks separately. For each track, note style: [scenario / debugging / architecture / tracing] and the angle of each question.
...
- **Tone/style notes:** [Editorial product-docs look, slate-blue accent, restrained visuals, actor naming convention, etc.]
